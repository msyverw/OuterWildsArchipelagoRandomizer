...
public static class LocationNames
{
    public static Dictionary<Location, string> locationNames = new Dictionary<Location, string> {
        ...
        { Location.FC_HOLE_OVERLOOK, "FC: Hole Overlook (Text Wall)" },
        { Location.FC_RECURSIVE_NODE, "FC: Recursive Node" },
        { Location.FC_VISIT_NORTHERN_CAMPSITE, "FC: Visit the Northern Campsite" },
        { Location.FC_NORTHERN_CAMPSITE_TEXT, "FC: Nothern Campsite (Text Wall)" },
        ...
        { Location.FC_AMYLAX_HOUSE, "FC: Small House" },
        { Location.FC_ALIEN_PARK_RECORDER, "FC: Alien Park (Text Wheel)" },
        { Location.FC_OBSERVATION_PLATFORM, "FC: Observation Platform (Text Wal)" },
        ...
        { Location.FC_ENZYME_LAB, "FC: Enzzyme Lab (Text Wall)" },
        ...
        { Location.FC_ABANDONED_SETTLEMENT_TEXT, "FC: Abandonded Settlement (Text Wall)" },
        { Location.FC_QUANTUM_CAVE, "FC: Enter the Quantum Cave" },
        { Location.FC_GAS_CAVE, "FC: Gas Cave (Text Wall)" },
        { Location.FC_EYE_SIGNAL_LAB, "FC: Eye Siganl Lab (Text Wall)" },
        ...
        { Location.FC_ABANDONED_SETTLEMENT_TANK, "FC: Abandonded Settlement Fuel Tank" },
