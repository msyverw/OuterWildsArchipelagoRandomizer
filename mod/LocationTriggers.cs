...
internal class LocationTriggers
{
    ...
    public static Dictionary<string, Location> logFactToDefaultLocation = new Dictionary<string, Location>{
        ...
        { "DB_BRAMBLE_VILLAGE_X3A", Location.TO_VILLAGE_DATURA_SCROLL },
        { "DB_BRAMBLE_VILLAGE_X3B", Location.TO_VILLAGE_FRIEND_SCROLL },
        ...
        { "CLUSTER_DISCOVERY_FACT_FC", Location.FC_TITANS_TEARS },
        { "CAMP_RUMOR_FC", Location.FC_TITANS_TEARS_SHELTER },
        { "HOLE_OVERLOOK_DISCOVERY_FACT_FC", Location.FC_HOLE_OVERLOOK },
        { "HOLE_ESCAPE_FACT_FC", Location.FC_HOLE_OVERLOOK_TEXT },
